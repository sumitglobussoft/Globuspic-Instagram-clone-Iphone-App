...
-(void)handleSingleTap:(id)sender{
    ...
    //added triangle
    whoText =[[UILabel alloc] initWithFrame: CGRectMake(10,-10,70,50)];
    whoText.text = @"who is this";
    whoText.font = [UIFont fontWithName:@"Helvetica-Bold" size:12];
    whoText.textColor=[UIColor whiteColor];
    whoText.hidden=NO;
    [whoIsThis addSubview:whoText];
