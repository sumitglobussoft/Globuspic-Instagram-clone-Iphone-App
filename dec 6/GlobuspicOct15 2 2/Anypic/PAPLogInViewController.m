...
- (void)viewDidLoad {
    ...
    if ([UIScreen mainScreen].bounds.size.height > 480.0f) {
        // for the iPhone 5
        self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"feature3@2x.png"]];
    } else {
        self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"feature3.png"]];
    }
    ...
    [textLabel setTextColor:[UIColor colorWithRed:0.0f/255.0f green:106.0f/255.0f blue:191.0f/255.0f alpha:1.0f]];
